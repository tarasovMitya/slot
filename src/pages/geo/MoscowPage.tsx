...
export function MoscowPage() {
  usePageMeta({
    title: "Бытовые услуги в Москве",
    description: "Электрик, сантехник, уборка, муж на час и другие бытовые услуги в Москве. Проверенные мастера, фиксированные цены, выезд в день заказа.",
